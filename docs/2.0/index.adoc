...
Second generation of the HtmlElements library is indeed yet another WebDriver wrapper, but
with a couple of fresh ideas:

. The hierarchy of page objects for your application is now a very flexible composition of java interfaces.
